...
public tooltipInterval1: number;
  ...
  changeSS1_2() {
    this.apiGetComp.GetJson(this.api.apiUrlNode1 + '/api/SS1_2')
    ...
    .subscribe((res: any)=>{
      ...
      this.velocidadSS1_2 = this.TeamSS1_2?.SS1_2_VelocidadActualMotor ?? 0;
  ...
  dataSS1_2(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.apiUrlNode1 + '/api/SS1_2'))
    )
    .subscribe((res: any) => {
      if (JSON.stringify(res)=='{}') {
        console.log('No hay data SS1_2');
