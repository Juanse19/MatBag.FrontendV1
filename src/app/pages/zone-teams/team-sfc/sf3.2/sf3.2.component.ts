...
public tooltipInterval1: number;
  ...
  changeSF3_2() {
    this.apiGetComp.GetJson(this.api.apiUrlNode1 + '/api/SF3_2')
    ...
    .subscribe((res: any)=>{
      ...
      this.velocidadSF3_2 = this.TeamSF3_2?.SF3_2_VelocidadActualMotor ?? 0;
    }
    this.dataSF3_2();
    });
  }
  ...
  dataSF3_2(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.apiUrlNode1 + '/api/SF3_2'))
    )
    .subscribe((res: any) => {
      if (JSON.stringify(res)=='{}') {
            // console.log('no hay data SF3_2');
