...
public tooltipInterval1: number;
  ...
  changeCS3_6M01() {
    this.apiGetComp.GetJson(this.api.apiUrlNode1 + '/api/CS3_6M01')
    ...
    .subscribe((res: any)=>{
      ...
      this.velocidadCS3_6M01 = this.decimalPipe.transform(this.TeamCS3_6M01?.CS3_6M01_VelocidadActualMotor) ?? 0;
      console.log('SF1_1:', this.TeamCS3_6M01);
    }
    this.dataCS3_6M01();
    });
  }
  ...
  dataCS3_6M01(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.apiUrlNode1 + '/api/CS3_6M01'))
    )
    .subscribe((res: any) => {
      if (JSON.stringify(res)=='{}') {
            // console.log('no hay data CS3_6M01');
            ...
            // this.dataSF1_1 = TeamSF1_1
            this.velocidadCS3_6M01 = this.decimalPipe.transform(this.TeamCS3_6M01?.CS3_6M01_VelocidadActualMotor) ?? 0;
            console.log('CS3_6M01:', this.TeamCS3_6M01?.CS3_6M01_VelocidadActualMotor);
          }
