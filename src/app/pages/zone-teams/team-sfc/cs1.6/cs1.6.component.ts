...
public tooltipInterval1: number;
  ...
  changeCS1_6M01() {
    this.apiGetComp.GetJson(this.api.apiUrlNode1 + '/api/CS1_6M01')
    ...
    .subscribe((res: any)=>{
      ...
      this.velocidadCS1_6M01 = this.decimalPipe.transform(this.TeamCS1_6M01?.CS1_6M01_VelocidadActualMotor) ?? 0;
      console.log('SF1_1:', this.TeamCS1_6M01);
    }
    this.dataCS1_6M01();
    });
  }
  ...
  dataCS1_6M01(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.apiUrlNode1 + '/api/CS1_6M01'))
    )
    .subscribe((res: any) => {
      if (JSON.stringify(res)=='{}') {
            // console.log('no hay data CS1_6M01');
            ...
            // this.dataSF1_1 = TeamSF1_1
            this.velocidadCS1_6M01 = this.decimalPipe.transform(this.TeamCS1_6M01?.CS1_6M01_VelocidadActualMotor) ?? 0;
            console.log('CS1_6M01:', this.TeamCS1_6M01?.CS1_6M01_VelocidadActualMotor);
          }
