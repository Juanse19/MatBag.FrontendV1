...
public tooltipInterval1: number;
  ...
  changeCL1_14() {
    ...
    .subscribe((res: any)=>{
      ...
      this.velocidadCL1_14 = this.TeamCL1_14?.CL1_14_VelocidadActualMotor ?? 0;
    }
    });
  }
  ...
  dataCL1_14(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.apiUrlNode1 + '/CL1_14'))
    )
    .subscribe((res: any) => {
      if (JSON.stringify(res)=='{}') {
            console.log('no hay data CL1_14');
