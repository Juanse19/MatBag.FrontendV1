...
public tooltipInterval1: number;
  ...
  changeCL1_9() {
    ...
    .subscribe((res: any)=>{
      ...
      this.velocidadCL1_9 = this.decimalPipe.transform(this.TeamCL1_9?.CL1_9_VelocidadActualMotor) ?? 0;
      console.log('SF1_1:', this.TeamCL1_9);
    }
    });
  }
  ...
  dataCL1_9(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.apiUrlNode1 + '/CL1_9'))
    )
    .subscribe((res: any) => {
      if (JSON.stringify(res)=='{}') {
            console.log('no hay data CL1_9');
            ...
            // this.dataSF1_1 = TeamSF1_1
            this.velocidadCL1_9 = this.decimalPipe.transform(this.TeamCL1_9?.CL1_9_VelocidadActualMotor) ?? 0;
            console.log('CL1_9:', this.TeamCL1_9?.CL1_9_VelocidadActualMotor);
          }
