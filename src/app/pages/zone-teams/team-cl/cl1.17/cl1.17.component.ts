...
public tooltipInterval1: number;
  ...
  changeCL1_17() {
    ...
    .subscribe((res: any)=>{
      ...
      this.velocidadCL1_17 = this.TeamCL1_17?.CL1_17_VelocidadActualMotor ?? 0;
    }
    });
  }
  ...
  dataCL1_17(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.apiUrlNode1 + '/CL1_17'))
    )
    .subscribe((res: any) => {
      if (JSON.stringify(res)=='{}') {
            console.log('no hay data CL1_17');
