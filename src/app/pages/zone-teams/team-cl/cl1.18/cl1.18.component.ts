...
public tooltipInterval1: number;
  ...
  changeCL1_18() {
    ...
    .subscribe((res: any)=>{
      ...
      this.velocidadCL1_18 = this.TeamCL1_18?.CL1_18_VelocidadActualMotor ?? 0;
    }
    });
  }
  ...
  dataCL1_18(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.apiUrlNode1 + '/CL1_18'))
    )
    .subscribe((res: any) => {
      if (JSON.stringify(res)=='{}') {
            console.log('no hay data CL1_18');
