...
public tooltipInterval1: number;
  ...
  changeSF1_10() {
    ...
    .subscribe((res: any)=>{
      ...
      this.velocidadSF1_10 = this.TeamSF1_10?.SF1_10_VelocidadActualMotor ?? 0;
    }
    this.dataSF1_10();
    });
  }
  ...
  dataSF1_10(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.apiUrlNode1 + '/api/SF1_10'))
    )
    .subscribe((res: any) => {
      if (JSON.stringify(res)=='{}') {
            console.log('no hay data SF1_10');
