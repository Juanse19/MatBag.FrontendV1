...
public tooltipInterval1: number;
  ...
  changeOSR1_6() {
    ...
    .subscribe((res: any)=>{
      ...
      this.velocidadOSR1_6 = this.TeamOSR1_6?.OSR1_6M01_VelocidadActualMotor ?? 0;
  ...
  dataOSR1_5(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.apiUrlNode1 + '/api/OSR1_6M01'))
    )
    .subscribe((res: any) => {
      if (JSON.stringify(res)=='{}') {
            console.log('no hay data OSR1_6');
