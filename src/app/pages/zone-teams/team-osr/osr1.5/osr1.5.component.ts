...
public tooltipInterval1: number;
  ...
  changeOSR1_5() {
    ...
    .subscribe((res: any)=>{
      ...
      this.velocidadOSR1_5 = this.TeamOSR1_5?.OSR1_5_VelocidadActualMotor ?? 0;
  ...
  dataOSR1_5(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.apiUrlNode1 + '/api/OSR1_5'))
    )
    .subscribe((res: any) => {
      if (JSON.stringify(res)=='{}') {
            console.log('no hay data OSR1_5');
