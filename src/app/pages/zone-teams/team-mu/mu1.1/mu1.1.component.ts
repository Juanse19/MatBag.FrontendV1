...
export interface MU1_1M02 {
  MU1_1M02_VelocidadActualMotor: number,
  MU1_1M02_CorrienteActualMotor: number,
  MU1_1M02_PotenciaActualMotor: number,
  MU1_1M02_TorqueActualMotor: number,
  MU1_1M02_KWh: number,
  MU1_1M02_voltaje: number
}
...
public tooltipInterval1: number;
  ...
  changeMU1_1M02() {
    ...
    .subscribe((res: any)=>{
      ...
      this.TeamMU1_1M02 = res[0]
      // this.dataSF1_1 = TeamSF1_1
      this.velocidadMU1_1M02 = this.TeamMU1_1M02?.MU1_1M02_VelocidadActualMotor ?? 0;
    }
    this.dataMU1_1M02();
    });
  }
  ...
  dataMU1_1M02(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.apiUrlNode1 + '/api/MU1_1M02'))
    )
    .subscribe((res: any) => {
      if (JSON.stringify(res)=='{}') {
            console.log('no hay data MU1_1M02');
